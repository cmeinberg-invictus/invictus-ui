...
export function HomePage() {
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-headline-sm font-medium text-text">Verena by Invictus AI</h1>
      ...
      <Panel className="overflow-hidden">
        <div className="border-b border-[color:var(--surface-border)] px-5 py-4">
          <h2 className="text-title-md font-medium text-text">Resume recent activity</h2>
        </div>
